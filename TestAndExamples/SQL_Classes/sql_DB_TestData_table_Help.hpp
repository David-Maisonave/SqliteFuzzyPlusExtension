...
class sql_DB_TestData_table_Help: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	sql_DB_TestData_table_Help() {} // Default constructor
	template <class T> sql_DB_TestData_table_Help(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<sql_DB_TestData_table_Help> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const sql_DB_TestData_table_Help& t);
	friend std::wostream& operator<<(std::wostream& os, const sql_DB_TestData_table_Help& t);
