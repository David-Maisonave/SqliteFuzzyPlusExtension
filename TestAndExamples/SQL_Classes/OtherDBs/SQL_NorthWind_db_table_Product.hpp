...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<SQL_NorthWind_db_table_Product> my_tbl;
		for (auto& row : my_tbl)
	...
	// Example #3
		for (auto r = my_tbl.begin(); r != my_tbl.end(); ++r)
			std::cout << r->get_Discontinued() << std::endl;
...
*/
#ifndef SQL_NORTHWIND_DB_TABLE_PRODUCT_H
#define SQL_NORTHWIND_DB_TABLE_PRODUCT_H
#include <string>
#include "..\..\sqlite3pp_ez\sqlite3pp_ez.h"

class SQL_NorthWind_db_table_Product: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	SQL_NorthWind_db_table_Product() {} // Default constructor
	template <class T> SQL_NorthWind_db_table_Product(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<SQL_NorthWind_db_table_Product> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const SQL_NorthWind_db_table_Product& t);
	friend std::wostream& operator<<(std::wostream& os, const SQL_NorthWind_db_table_Product& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const SQL_NorthWind_db_table_Product& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const SQL_NorthWind_db_table_Product& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_NORTHWIND_DB_TABLE_PRODUCT_H
