...
*/
#ifndef SQL_DB_NORTHWIND_TABLE_EMPLOYEETERRITORY_HPP
#define SQL_DB_NORTHWIND_TABLE_EMPLOYEETERRITORY_HPP
#include <string>
...
#endif // !SQL_DB_NORTHWIND_TABLE_EMPLOYEETERRITORY_HPP
