#ifndef SQL_DB_GAMENAMES_MASTER_HEADER_H
#define SQL_DB_GAMENAMES_MASTER_HEADER_H
#include <string>
#include "..\sqlite3pp_ez.h"
#include "sql_DB_GameNames_table_AlternateNames.h"
...
#endif // !SQL_DB_GAMENAMES_MASTER_HEADER_H
