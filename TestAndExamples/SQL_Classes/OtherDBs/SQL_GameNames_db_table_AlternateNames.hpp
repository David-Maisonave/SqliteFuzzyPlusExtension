...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<SQL_GameNames_db_table_AlternateNames> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_GAMENAMES_DB_TABLE_ALTERNATENAMES_H
#define SQL_GAMENAMES_DB_TABLE_ALTERNATENAMES_H
#include <string>
#include "..\..\sqlite3pp_ez\sqlite3pp_ez.h"

class SQL_GameNames_db_table_AlternateNames: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	SQL_GameNames_db_table_AlternateNames() {} // Default constructor
	template <class T> SQL_GameNames_db_table_AlternateNames(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<SQL_GameNames_db_table_AlternateNames> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const SQL_GameNames_db_table_AlternateNames& t);
	friend std::wostream& operator<<(std::wostream& os, const SQL_GameNames_db_table_AlternateNames& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const SQL_GameNames_db_table_AlternateNames& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const SQL_GameNames_db_table_AlternateNames& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_GAMENAMES_DB_TABLE_ALTERNATENAMES_H
