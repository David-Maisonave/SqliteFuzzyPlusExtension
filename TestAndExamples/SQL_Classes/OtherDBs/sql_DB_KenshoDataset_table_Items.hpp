...
*/
#ifndef SQL_DB_KENSHODATASET_TABLE_ITEMS_HPP
#define SQL_DB_KENSHODATASET_TABLE_ITEMS_HPP
#include <string>
...
#endif // !SQL_DB_KENSHODATASET_TABLE_ITEMS_HPP
