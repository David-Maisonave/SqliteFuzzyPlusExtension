...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<sql_DB_sakila_view_customer_list> my_tbl;
		for (auto row : my_tbl)
...
*/
#ifndef SQL_DB_SAKILA_VIEW_CUSTOMER_LIST_H
#define SQL_DB_SAKILA_VIEW_CUSTOMER_LIST_H
#include <string>
#include "..\sqlite3pp_ez.h"

class sql_DB_sakila_view_customer_list: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	sql_DB_sakila_view_customer_list() {} // Default constructor
	template <class T> sql_DB_sakila_view_customer_list(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<sql_DB_sakila_view_customer_list> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const sql_DB_sakila_view_customer_list& t);
	friend std::wostream& operator<<(std::wostream& os, const sql_DB_sakila_view_customer_list& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const sql_DB_sakila_view_customer_list& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const sql_DB_sakila_view_customer_list& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_DB_SAKILA_VIEW_CUSTOMER_LIST_H
