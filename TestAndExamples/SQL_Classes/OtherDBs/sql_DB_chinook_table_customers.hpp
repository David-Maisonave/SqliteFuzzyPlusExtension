...
*/
#ifndef SQL_DB_CHINOOK_TABLE_CUSTOMERS_HPP
#define SQL_DB_CHINOOK_TABLE_CUSTOMERS_HPP
#include <string>
#include "..\sqlite3pp_ez.h"

class sql_DB_chinook_table_customers: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	sql_DB_chinook_table_customers() {} // Default constructor
	template <class T> sql_DB_chinook_table_customers(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<sql_DB_chinook_table_customers> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const sql_DB_chinook_table_customers& t);
	friend std::wostream& operator<<(std::wostream& os, const sql_DB_chinook_table_customers& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const sql_DB_chinook_table_customers& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const sql_DB_chinook_table_customers& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_DB_CHINOOK_TABLE_CUSTOMERS_HPP
