...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<SQL_sakila_db_table_store> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_SAKILA_DB_TABLE_STORE_H
#define SQL_SAKILA_DB_TABLE_STORE_H
#include <string>
#include "..\..\sqlite3pp_ez\sqlite3pp_ez.h"

class SQL_sakila_db_table_store: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	SQL_sakila_db_table_store() {} // Default constructor
	template <class T> SQL_sakila_db_table_store(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<SQL_sakila_db_table_store> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const SQL_sakila_db_table_store& t);
	friend std::wostream& operator<<(std::wostream& os, const SQL_sakila_db_table_store& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const SQL_sakila_db_table_store& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const SQL_sakila_db_table_store& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_SAKILA_DB_TABLE_STORE_H
