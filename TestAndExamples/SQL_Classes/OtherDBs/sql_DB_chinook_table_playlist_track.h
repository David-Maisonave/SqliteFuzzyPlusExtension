...
Example Usage:		(Using sqlite3pp::Table container)
	...
	// Example #3
		for (auto r = my_tbl.begin(); r != my_tbl.end(); ++r)
			std::wcout << r->get_TrackId() << std::endl;

For more details see  https://github.com/David-Maisonave/sqlite3pp_EZ
*/
#ifndef SQL_DB_CHINOOK_TABLE_PLAYLIST_TRACK_H
#define SQL_DB_CHINOOK_TABLE_PLAYLIST_TRACK_H
#include <string>
...
#endif // !SQL_DB_CHINOOK_TABLE_PLAYLIST_TRACK_H
