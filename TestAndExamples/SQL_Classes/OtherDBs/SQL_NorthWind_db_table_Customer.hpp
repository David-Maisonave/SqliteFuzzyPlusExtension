...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<SQL_NorthWind_db_table_Customer> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_NORTHWIND_DB_TABLE_CUSTOMER_H
#define SQL_NORTHWIND_DB_TABLE_CUSTOMER_H
#include <string>
#include "..\..\sqlite3pp_ez\sqlite3pp_ez.h"

class SQL_NorthWind_db_table_Customer: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	SQL_NorthWind_db_table_Customer() {} // Default constructor
	template <class T> SQL_NorthWind_db_table_Customer(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<SQL_NorthWind_db_table_Customer> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const SQL_NorthWind_db_table_Customer& t);
	friend std::wostream& operator<<(std::wostream& os, const SQL_NorthWind_db_table_Customer& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const SQL_NorthWind_db_table_Customer& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const SQL_NorthWind_db_table_Customer& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_NORTHWIND_DB_TABLE_CUSTOMER_H
