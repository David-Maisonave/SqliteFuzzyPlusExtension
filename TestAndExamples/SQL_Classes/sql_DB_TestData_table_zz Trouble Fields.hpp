...
*/
#ifndef SQL_DB_TESTDATA_TABLE_ZZ__TROUBLE__FIELDS_HPP
#define SQL_DB_TESTDATA_TABLE_ZZ__TROUBLE__FIELDS_HPP
#include <string>
...
#endif // !SQL_DB_TESTDATA_TABLE_ZZ TROUBLE FIELDS_HPP
