...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<SQL_TestData_db_table_zTroubleFields> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_TESTDATA_DB_TABLE_ZTROUBLEFIELDS_H
#define SQL_TESTDATA_DB_TABLE_ZTROUBLEFIELDS_H
#include <string>
#include "..\sqlite3pp_EZ\sqlite3pp_ez.h"

class SQL_TestData_db_table_zTroubleFields: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	SQL_TestData_db_table_zTroubleFields() {} // Default constructor
	template <class T> SQL_TestData_db_table_zTroubleFields(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<SQL_TestData_db_table_zTroubleFields> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const SQL_TestData_db_table_zTroubleFields& t);
	friend std::wostream& operator<<(std::wostream& os, const SQL_TestData_db_table_zTroubleFields& t);
	static StrType Delimiter() { return "," ; }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const SQL_TestData_db_table_zTroubleFields& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const SQL_TestData_db_table_zTroubleFields& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_TESTDATA_DB_TABLE_ZTROUBLEFIELDS_H
