...
, IsSomeWhatSimilar(Phrases, 'This is a similar phrase test', 27) as a27 -- DiceSimilarity (ID# 27)
...
, IsSomeWhatSimilar(Phrases, 'This is a similar phrase test', 286) as a286 -- iDiceSimilarity (ID# 286)
FROM SimilarPhrase;
