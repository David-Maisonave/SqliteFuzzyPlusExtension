...
, SameSound(Words, 'being', 3) as a3 -- EnPhoneticDistance (ID# 3)
, SameSound(Words, 'being', 4) as a4 -- fuzzy_caver (ID# 4)
, SameSound(Words, 'being', 5) as a5 -- fuzzy_phonetic (ID# 5)
, SameSound(Words, 'being', 6) as a6 -- fuzzy_soundex (ID# 6)
, SameSound(Words, 'being', 7) as a7 -- fuzzy_rsoundex (ID# 7)
