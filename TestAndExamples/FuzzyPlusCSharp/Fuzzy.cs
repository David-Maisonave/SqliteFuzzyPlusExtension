...
namespace FuzzyPlusCSharp
{
    ...
    public static class Fuzzy
    {
        ...
        // Distance classes
        public static BlockDistance blockDistance = new BlockDistance();
        public static ChapmanLengthDeviation chapmanLengthDeviation = new ChapmanLengthDeviation();
        public static ChapmanMeanLength chapmanMeanLength = new ChapmanMeanLength();
        public static EuclideanDistance euclideanDistance = new EuclideanDistance();
        public static MatchingCoefficient matchingCoefficient = new MatchingCoefficient();
        public static MongeElkan mongeElkan = new MongeElkan();
        public static QGramsDistance qGramsDistance = new QGramsDistance();
        public static SmithWaterman smithWaterman = new SmithWaterman();
        public static SmithWatermanGotoh smithWatermanGotoh = new SmithWatermanGotoh();
        public static SmithWatermanGotohWindowedAffine smithWatermanGotohWindowedAffine = new SmithWatermanGotohWindowedAffine();
        public static DiceSimilarity diceSimilarity = new DiceSimilarity();
        // Phonetic classes
