...
public:
	...
	static StrType getTableName() { return _T("SimilarPhrase" ); }
	static StrType getColumnNames() { return _T("Phrases"); }
	static StrType getSelectColumnNames() { return _T("'Phrases'"); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  _T("'") + sqlite3pp::to_tstring( Phrases) + _T("'");
		return strtype;
	}
