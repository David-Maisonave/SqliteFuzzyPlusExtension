...
public:
	...
	static StrType getTableName() { return _T("zz Trouble Fields" ); }
	static StrType getColumnNames() { return _T("\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""); }
	static StrType getSelectColumnNames() { return _T("\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  _T("'") + sqlite3pp::to_tstring( Some__Names) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Zip__Code) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( City__and__State) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Area__Code) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Bad__Type) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Is__US__Born) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Is__US__Citizen__) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Unsigned__Big__Integer__Support) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Unsigned__Big__Integer__Support2) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Big__Integer__Support) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Big__Integer__Support__2) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Big__Integer__Support__3) + _T("'");
		return strtype;
	}
