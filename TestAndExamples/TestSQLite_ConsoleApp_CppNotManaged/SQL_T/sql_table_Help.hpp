...
public:
	...
	static StrType getTableName() { return _T("Help" ); }
	static StrType getColumnNames() { return _T("\"Function\", \"Description\", \"Arguments\", \"Return\", \"Details\", \"ExtensionAlias\", \"WikiAlias\""); }
	static StrType getSelectColumnNames() { return _T("\"Function\", \"Description\", \"Arguments\", \"Return\", \"Details\", \"ExtensionAlias\", \"WikiAlias\""); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  _T("'") + sqlite3pp::to_tstring( Function) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Description) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Arguments) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Return) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( Details) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( ExtensionAlias) + _T("'");
		strtype +=  _T(",'") + sqlite3pp::to_tstring( WikiAlias) + _T("'");
		return strtype;
	}
