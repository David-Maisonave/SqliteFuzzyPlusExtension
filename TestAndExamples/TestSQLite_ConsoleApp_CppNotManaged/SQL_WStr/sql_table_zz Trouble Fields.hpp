...
public:
	...
	static StrType getTableName() { return L"zz Trouble Fields" ; }
	static StrType getColumnNames() { return L"\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""; }
	static StrType getSelectColumnNames() { return L"\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""; }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  L"'" + sqlite3pp::to_wstring( Some__Names) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Zip__Code) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( City__and__State) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Area__Code) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Bad__Type) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Is__US__Born) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Is__US__Citizen__) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Unsigned__Big__Integer__Support) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Unsigned__Big__Integer__Support2) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Big__Integer__Support) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Big__Integer__Support__2) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Big__Integer__Support__3) + L"'";
		return strtype;
	}
