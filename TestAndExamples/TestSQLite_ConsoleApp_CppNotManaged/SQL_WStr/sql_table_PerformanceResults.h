...
public:
	...
	static StrType getTableName() { return L"PerformanceResults" ; }
	static StrType getColumnNames() { return L"FunctionName, FunctionID, QueryText, QtyRowsReturned, Results, Notes, Performance10KRows, Performance100KRows, Performance1MillionRows, Performance5MillionRows, Performance10MillionRows"; }
	static StrType getSelectColumnNames() { return L"'FunctionName', 'FunctionID', 'QueryText', 'QtyRowsReturned', 'Results', 'Notes', 'Performance10KRows', 'Performance100KRows', 'Performance1MillionRows', 'Performance5MillionRows', 'Performance10MillionRows'"; }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  L"'" + sqlite3pp::to_wstring( FunctionName) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( FunctionID) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( QueryText) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( QtyRowsReturned) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Results) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Notes) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Performance10KRows) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Performance100KRows) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Performance1MillionRows) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Performance5MillionRows) + L"'";
		strtype +=  L",'" + sqlite3pp::to_wstring( Performance10MillionRows) + L"'";
		return strtype;
	}
