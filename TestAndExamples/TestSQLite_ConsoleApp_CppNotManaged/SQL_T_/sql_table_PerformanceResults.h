...
public:
	...
	{
		StrType strtype;
		strtype +=  T_("'") + sqlite3pp::to_tstring( FunctionName) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( FunctionID) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( QueryText) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( QtyRowsReturned) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Results) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Notes) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Performance10KRows) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Performance100KRows) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Performance1MillionRows) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Performance5MillionRows) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Performance10MillionRows) + T_("'");
		return strtype;
	}
