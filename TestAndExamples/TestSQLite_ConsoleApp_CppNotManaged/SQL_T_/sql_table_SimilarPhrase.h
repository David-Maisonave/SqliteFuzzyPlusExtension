...
public:
	...
	static StrType getTableName() { return T_("SimilarPhrase" ); }
	static StrType getColumnNames() { return T_("Phrases"); }
	static StrType getSelectColumnNames() { return T_("'Phrases'"); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  T_("'") + sqlite3pp::to_tstring( Phrases) + T_("'");
		return strtype;
	}
