...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<sql_table_zTroubleFields> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_TABLE_ZTROUBLEFIELDS_H
#define SQL_TABLE_ZTROUBLEFIELDS_H
#include "..\sqlite3pp_ez.h"

class sql_table_zTroubleFields: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	sql_table_zTroubleFields() {} // Default constructor
	template <class T> sql_table_zTroubleFields(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names

	// getTableName, getColumnNames, getSelectColumnNames, and getStreamData are required for sqlite3pp::Table template class
	static StrType getTableName() { return T_("zTroubleFields" ); }
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<sql_table_zTroubleFields> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const sql_table_zTroubleFields& t);
	friend std::wostream& operator<<(std::wostream& os, const sql_table_zTroubleFields& t);
	static StrType Delimiter() { return T_("," ); }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const sql_table_zTroubleFields& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const sql_table_zTroubleFields& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_TABLE_ZTROUBLEFIELDS_H
