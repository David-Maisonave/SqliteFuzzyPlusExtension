...
Example Usage:		(Using sqlite3pp::Table container)
	// Example #1
		...
		sqlite3pp::Table<sql_table_zz Trouble Fields> my_tbl;
		for (auto& row : my_tbl)
...
*/
#ifndef SQL_TABLE_ZZ__TROUBLE__FIELDS_H
#define SQL_TABLE_ZZ__TROUBLE__FIELDS_H
#include "..\sqlite3pp_ez.h"

class sql_table_zz__Trouble__Fields: public sqlite3pp::sql_base
{
...
public:
	...
	// Constructors
	sql_table_zz__Trouble__Fields() {} // Default constructor
	template <class T> sql_table_zz__Trouble__Fields(const T &t) { setData(t); } // Allows data input from different (or same) tables/views having the same data types and column names

	// getTableName, getColumnNames, getSelectColumnNames, and getStreamData are required for sqlite3pp::Table template class
	static StrType getTableName() { return T_("zz Trouble Fields" ); }
	static StrType getColumnNames() { return T_("\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""); }
	static StrType getSelectColumnNames() { return T_("\"Some Names\", \"Zip Code\", \"City and State\", \"Area Code\", \"Bad Type\", \"Is US Born\", \"Is US Citizen \", \"Unsigned Big Integer Support\", \"Unsigned Big Integer Support2\", \"Big Integer Support\", \"Big Integer Support 2\", \"Big Integer Support 3\""); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  T_("'") + sqlite3pp::to_tstring( Some__Names) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Zip__Code) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( City__and__State) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Area__Code) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Bad__Type) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Is__US__Born) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Is__US__Citizen__) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Unsigned__Big__Integer__Support) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Unsigned__Big__Integer__Support2) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Big__Integer__Support) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Big__Integer__Support__2) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Big__Integer__Support__3) + T_("'");
		return strtype;
	}
	...
	Example Usage:		(Using sqlite3pp::TableOStream container)
			TableOStream<sql_table_zz__Trouble__Fields> tbl(DbFileNameArg("myDatabase.db"));
	...
	*/
	...
	friend std::ostream& operator<<(std::ostream& os, const sql_table_zz__Trouble__Fields& t);
	friend std::wostream& operator<<(std::wostream& os, const sql_table_zz__Trouble__Fields& t);
	static StrType Delimiter() { return T_("," ); }
	////////////////////////////////////////////////////////////////////////////////////////////
};
// sqlite3pp::TableOStream container interface.
inline std::ostream& operator<<(std::ostream& os, const sql_table_zz__Trouble__Fields& t) { sqlite3pp::ostream_a o(os, t.Delimiter()); return t.OStream(o).os; }
inline std::wostream& operator<<(std::wostream& os, const sql_table_zz__Trouble__Fields& t) { sqlite3pp::ostream_w o(os, t.Delimiter());  return t.OStream(o).os; }

#endif // !SQL_TABLE_ZZ TROUBLE FIELDS_H
