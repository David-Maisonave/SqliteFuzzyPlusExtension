...
public:
	...
	static StrType getTableName() { return T_("Help" ); }
	static StrType getColumnNames() { return T_("\"Function\", \"Description\", \"Arguments\", \"Return\", \"Details\", \"ExtensionAlias\", \"WikiAlias\""); }
	static StrType getSelectColumnNames() { return T_("\"Function\", \"Description\", \"Arguments\", \"Return\", \"Details\", \"ExtensionAlias\", \"WikiAlias\""); }
	StrType GetValues() const
	{
		StrType strtype;
		strtype +=  T_("'") + sqlite3pp::to_tstring( Function) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Description) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Arguments) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Return) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( Details) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( ExtensionAlias) + T_("'");
		strtype +=  T_(",'") + sqlite3pp::to_tstring( WikiAlias) + T_("'");
		return strtype;
	}
