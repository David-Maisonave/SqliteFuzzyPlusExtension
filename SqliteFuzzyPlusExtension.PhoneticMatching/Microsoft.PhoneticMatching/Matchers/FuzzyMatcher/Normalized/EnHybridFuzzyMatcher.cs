...
namespace Microsoft.PhoneticMatching.Matchers.FuzzyMatcher.Normalized
{
    ...
    {
        private readonly double phoneticWeightPercentage = 0;
        private readonly EnPronouncer pronouncer = EnPronouncer.Instance;
        ...
        public EnHybridFuzzyMatcher(IList<Target> targets, double phoneticWeightPercentage, Func<Target, string> targetToExtractionPhrase = null, bool isAccelerated = true)
        {
            ...
            DistanceInput targetToExtraction(Target target)
            {
                ...
                return phrase == null
                    ...
                    : new DistanceInput(phrase, this.pronouncer.Pronounce(phrase));
            }
