...
, Similar(Words, 'David', 'MongeElkan') as a74 -- MongeElkan (ID# 74)
...
, Similar(Words, 'David', 'ExactMatch') as a135 -- ExactMatch (ID# 135)
...
, Similar(Words, 'David', 'iMongeElkan') as a330 -- iMongeElkan (ID# 330)
FROM SimilarWords;
