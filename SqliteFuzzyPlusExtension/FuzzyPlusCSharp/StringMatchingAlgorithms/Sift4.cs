...
namespace FuzzyPlusCSharp.StringMatchingAlgorithms
{
    public class ISift4 : FuzzyPlusCSharp.StringMatchingAlgorithms.IDistance
    {
        ...
        ///     The algorithm will stop if the distance reaches MaxDistance value
        /// <returns></returns>
        ...
        public double Distance(string source1, string source2, bool isCaseSensitive = true)
        {
            ...
            return sift4.GeneralDistance(source1, source2, maxOffset);
        }
    }
    public class Sift4
    {
        ...
        /// <param name="s1"></param>
        /// <param name="s2"></param>
        /// <param name="maxOffset"></param> // maxOffset is the number of characters to search for matching letters
        /// <returns></returns>
