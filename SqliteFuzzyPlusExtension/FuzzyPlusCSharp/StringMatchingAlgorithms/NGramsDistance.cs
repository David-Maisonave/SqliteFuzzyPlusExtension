...
{
    public class NGramsDistance :  FuzzyPlusCSharp.StringMatchingAlgorithms.IDistance
    {
        public double Percentage(string source1, string source2, bool isCaseSensitive = true)
        {
            ...
            double d = NGram(source1, source2);
            return d * .01;
        }
        ...
        private readonly bool isSequential;

        /// <summary>
        /// Creates a LookingGlass instance with sequential search.
        /// </summary>
        public NGramsDistance()
        {
        ...
        /// </summary>
        /// <param name="isSequential">Defines if search is limited to sequential mode.</param>
        public NGramsDistance(bool isSequential)
        {
