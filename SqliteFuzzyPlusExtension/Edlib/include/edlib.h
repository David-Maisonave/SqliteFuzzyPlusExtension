...
// Status codes
const int EDLIB_STATUS_OK = 0;
const int EDLIB_STATUS_ERROR = 1;
...
// Edit operations.
    const int EDLIB_EDOP_MATCH = 0;    //!< Match.
    const int EDLIB_EDOP_INSERT = 1;   //!< Insertion to target = deletion from query.
    const int EDLIB_EDOP_DELETE = 2;   //!< Deletion from target = insertion to query.
    const int EDLIB_EDOP_MISMATCH = 3; //!< Mismatch.
