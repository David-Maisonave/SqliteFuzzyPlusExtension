...
, HowSimilar(Name, "David Jorge", 32) as a32 -- Fuzzy_Damlev = SQLEAN_FUZZY,
, HowSimilar(Name, "David Jorge", 33) as a33 -- Fuzzy_Hamming,
, HowSimilar(Name, "David Jorge", 34) as a34 -- Fuzzy_Jarowin,
, HowSimilar(Name, "David Jorge", 35) as a35 -- Fuzzy_Leven,
, HowSimilar(Name, "David Jorge", 36) as a36 -- Fuzzy_Osadist,
, HowSimilar(Name, "David Jorge", 37) as a37 -- Fuzzy_Editdist,
, HowSimilar(Name, "David Jorge", 38) as a38 -- Fuzzy_Jaro,
